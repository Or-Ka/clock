...
- Added a halftone state for events that already passed today across complete clock markers, custom icons and event-list rows while keeping next and future events at full emphasis.
